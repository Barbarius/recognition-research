#Retrain VGG19 neural network model based on imagenet wheights

#python3 VGG19_retrain.py 4 10 "../../mushroom-images/Mushrooms_with_classes/" "../../mushroom-images/Mushrooms_with_classes/"
...
def create_trainable_VGG19(classes_count):
...
def train_model(model, train_generator, validation_generator, epochs):
    csv_logger = CSVLogger('VGG19_log.csv', append=True, separator=';')
...
model = create_trainable_VGG19(number_of_classes)
compile_model(model)
...
save_model_to_h5(model, '.', 'VGG19_model_with_weights.h5')
