...
#python3 MobileNetV2_retrain.py 4 10 "../../mushroom-images/Mushrooms_with_classes/" "../../mushroom-images/Mushrooms_with_classes/"
...
def train_model(model, train_generator, validation_generator, epochs):
    csv_logger = CSVLogger('MobileNetV2_log.csv', append=True, separator=';')
...
save_model_to_h5(model, '.', 'MobileNetV2_model_with_weights.h5')
